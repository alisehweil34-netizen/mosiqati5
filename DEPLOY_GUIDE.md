...
## محرك القراءة الصوتية (زر 🔊 اقرأ)
تمت إضافة مجلد `tts-engine/` ويحتوي على محرك نطق (eSpeak-ng) يعمل بالكامل
داخل المتصفح دون الحاجة لأي صوت عربي مثبت على جهاز الزائر أو اتصال إنترنت.
هذا المحرك مرخّص بموجب **GPLv3** (راجع `tts-engine/LICENSE-espeak-ng.txt`)،
فإذا نشرت الموقع كمصدر مفتوح فأنت ملتزم أصلاً بالترخيص، وإن كان استخدامك
تجارياً مغلق المصدر يُفضّل مراجعة شروط GPLv3 قبل النشر.
